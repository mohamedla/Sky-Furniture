...
<main>
    ...
    <div class="control">
        ...
        <form method="POST" action="/categories/{{$category->category_id}}">
            @csrf
            <!-- Name -->
            <div>
                <label for="category_name">Name</label>
                <div class="input-con">
                    <input class="input disabled" readonly value="{{$category->category_name}}"  type="text" name="category_name" required>
                    <div class="change">
